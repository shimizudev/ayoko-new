...
import { MangaInfo, Title } from '@/lib/fetch/manga';
...
function MangaActions() {
  return (
    ...
    >
      <Button className="w-full sm:w-auto">Read Now</Button>
...
export default function MangaInfoContainer({
  manga,
}: MangaInfoProps): JSX.Element {
  const {
    title,
    coverImage,
    bannerImage,
